...
?>
      ...
      <head>
        ...
        <title>Burgerak - View Pending</title>
  ...
  <form method= "post" action="updatePending.php" >
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    <div class="col-25">
      <label for="shipment">Order Time</label>
    </div>
    <div class="col-75">
      <input type="text" id="shipment" name="shipment" value="<?php echo $dataF['order_time']?>" readonly required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      ...
      <div class="row">
    <div class="col-25">
      <label for="lname">Shipment</label>
    </div>
    <div class="col-75">
      <input type="text" id="shipment" name="shipment" value="<?php echo $dataF['shipment_type']?>" readonly required>
            ...
            <div class="table-responsive">
                              ...
                              if($rowView>0)
                              {
                                ...
                                while($res = mysqli_fetch_assoc($qrydataView))
                                {
                                  ...
                                  <tr>
                                    ...
                                    <td><input type="checkbox" id="status" name="status" value="" required> </td>
              ...
              <hr>
              <a href="pendingTable.php"><button  type="button" style="width:120px;height:60px;font-size:14pt;font-weight:bold;">BACK</button></a>
            
              <button type="submit" style="width:135px;height:60px;font-size:14pt;font-weight:bold;" >UPDATE</button>
