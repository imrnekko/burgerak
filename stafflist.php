...
?>
      ...
      <head>
        ...
        <title>Burgerak - Staff List</title>
                          ...
                          if($rowView>0)
                          {
                            ...
                            while($res = mysqli_fetch_assoc($qrydataView))
                            {
                              ...
                              <tr>
                                ...
                                <td><a class="btn btn-primary btn-lg" href="mail/emailverifystaff.php?adminid=<?php echo $res['admin_id'];?>">Send Verification</a>

                                <?php if($res['admin_id'] != 1){?>
                                <a class="btn btn-info btn-lg" href="deletestaff.php?adminid=<?php echo $res['admin_id'];?>">Delete</a></td>
                                <?php } ?>
                                </tr>
