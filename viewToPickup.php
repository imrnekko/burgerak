...
?>
      ...
      <head>
        ...
        <title>Burgerak - View To Pickup</title>
  ...
  <form method= "post" action="updateToPickup.php" >
  <div class="row">
    <div class="col-25">
  ...
  <div class="row">
    <div class="col-25">
      <label for="shipment">Completed Time</label>
    </div>
    <div class="col-75">
      <input type="text" id="shipment" name="shipment" value="<?php echo $dataF['complete_time']?>" readonly required>
    </div>
  </div>
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
      <input type="text" id="shipment" name="shipment" value="<?php echo $dataF['shipment_type']?>" readonly required>
            ...
            <div class="table-responsive">
              ...
              <hr>
              <a href="toPickupTable.php"><button  type="button" style="width:120px;height:60px;font-size:14pt;font-weight:bold;">BACK</button></a>
