...
?>
      ...
      <head>
        ...
        <title>Burgerak - Order To Pickup List</title>
          ...
          <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <div class="table-responsive">
              ...
              <table id="table">
                          ...
                          $sqlView = "SELECT * FROM orderstatus os join orders o on os.orderstatus_id = o.orderstatus_id WHERE o.orderstatus_id = 3 AND o.shipment_id = 1" ;
                          ...
                          if($rowView>0)
                          {
                            ...
                            while($res = mysqli_fetch_assoc($qrydataView))
                            {
                              ...
                              <tr>
                                ...
                                <td><?php echo $res['estimated_pickuptime'];?></td>
                                <td>RM <?php echo number_format((float)$res['total_price'], 2, '.', '');?></td>
                                <td><a class="btn btn-info btn-lg" href="viewToPickup.php?orderid=<?php echo $res['order_id'];?>">View</a></td>
                          ...
                          <?php $counter++;  }
                            ...
                            echo "THERE'S NO ORDER TO PICKUP";
                          } ?>
