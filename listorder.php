...
?>
      ...
      <head>
        ...
        <title>Burgerak - Order List</title>
          ...
          <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <div class="table-responsive">
              ...
              <table id="table">
                          ...
                          $sqlView = "SELECT * FROM orderstatus os join orders o on os.orderstatus_id = o.orderstatus_id join customer c on o.cust_id = c.cust_id
                                       where c.cust_username = '".$_SESSION['username']."' and o.orderstatus_id not like 1 and o.orderstatus_id not like 6";
                          ...
                          if($rowView>0)
                          {
                            ...
                            while($res = mysqli_fetch_assoc($qrydataView))
                            {
                              ...
                              <tr>
                                ...
                                <td><?php echo $res['orderstatus_name'];?></td>
                                <td>RM <?php echo number_format((float)$res['total_price'], 2, '.', '');?></td>
                                <td><a class="btn btn-info btn-lg" href="vieworder.php?orderid=<?php echo $res['order_id'];?>">View</a></td>
