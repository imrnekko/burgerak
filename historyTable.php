...
?>
      ...
      <head>
        ...
        <title>Burgerak - Previous Order List</title>
          ...
          <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <div class="table-responsive">
              ...
              <table id="table">
                          ...
                          $sqlView = "SELECT * FROM orderstatus os join orders o on os.orderstatus_id = o.orderstatus_id WHERE o.orderstatus_id = 4 or o.orderstatus_id = 5 ";
                          ...
                          if($rowView>0)
                          {
                            ...
                            while($res = mysqli_fetch_assoc($qrydataView))
                            {
                              ...
                              <tr>
                                ...
                                <td><a class="btn btn-info btn-lg" href="viewHistory.php?orderid=<?php echo $res['order_id'];?>">View</a></td>
