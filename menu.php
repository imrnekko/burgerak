  ...
  <main id="main">
          <nav id="sidebar" class="sidebar">
              <div class="sidebar-header">
                  <h4><i class="fas fa-shopping-cart"></i> CART LIST</h4>
                  <strong>HEA </strong>
              </div>

              <ul class="list-unstyled components">

                <form action = "neworder.php" method="post" style="width:100%;">
                  <li class="sidebar-nav">
                        <table> 
                         <div class="field_wrapper" style="padding-left:20px;font-size:10pt;">
                         </div>
                        </table>
      ...
      <section id="menu" class="portfolio">
        ...
        <div class="container">
          ...
          <div class="section-title" data-aos="fade-down" data-aos-delay="100">
            <h2>MENU</h2>
            <p>Welcome to Burgerak. We provide you the best food with high quality.</p>
          </div>
          </center>
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-burger">
                        <div class="portfolio-wrap">
                          ...
                          <p id="selectPrice<?php echo $index; ?>" value="<?php echo number_format((float)$dataB['menu_price'], 2, '.', ''); ?>">RM <?php echo number_format((float)$dataB['menu_price'], 2, '.', ''); ?></p>                            <div class="portfolio-links">
                              <a href="<?php echo $dataB['menu_img']; ?>" data-gall="portfolioGallery" class="venobox" title="App 1"><button>ZOOM</button></a>
                              <a data-toggle="modal" data-target="#addtocart" title="Add to Cart"><button id="<?php echo $index; ?>"onClick="copyMenu(this.id)">ADD CART</button></a>
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            ...
                            <p id="selectPrice<?php echo $index; ?>" value="<?php echo number_format((float)$dataD['menu_price'], 2, '.', ''); ?>">RM <?php echo number_format((float)$dataD['menu_price'], 2, '.', ''); ?></p>                            <div class="portfolio-links">
                              <a href="<?php echo $dataD['menu_img']; ?>" data-gall="portfolioGallery" class="venobox" title="Card 2"><button>ZOOM</button></a>
                              <a data-toggle="modal" data-target="#addtocart" title="Add to Cart"><button id="<?php echo $index; ?>" onClick="copyMenu(this.id)">ADD CART</button></a>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            ...
                            <div class="portfolio-links">
                              <a href="<?php echo $dataS['menu_img']; ?>" data-gall="portfolioGallery" class="venobox" title="Card 2"><button>ZOOM</button></a>
                              <a data-toggle="modal" data-target="#addtocart" title="Add to Cart"><button id="<?php echo $index; ?>" onClick="copyMenu(this.id)">ADD CART</button></a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-smoothie">
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            ...
                            <p id="selectPrice<?php echo $index; ?>" value="<?php echo number_format((float)$dataSM['menu_price'], 2, '.', ''); ?>">RM <?php echo number_format((float)$dataSM['menu_price'], 2, '.', ''); ?></p>                            <div class="portfolio-links">
                              <a href="<?php echo $dataSM['menu_img']; ?>" data-gall="portfolioGallery" class="venobox" title="Card 2"><button>ZOOM</button></a>
                              <a data-toggle="modal" data-target="#addtocart" title="Add to Cart"><button id="<?php echo $index; ?>" onClick="copyMenu(this.id)">ADD CART</button></a>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-lg-4 col-md-6 portfolio-item filter-desserts">
                        <div class="portfolio-wrap">
                          ...
                          <div class="portfolio-info">
                            ...
                            <p id="selectPrice<?php echo $index; ?>" value="<?php echo number_format((float)$dataDS['menu_price'], 2, '.', ''); ?>">RM <?php echo number_format((float)$dataDS['menu_price'], 2, '.', ''); ?></p>                            <div class="portfolio-links">
                              <a href="<?php echo $dataDS['menu_img']; ?>" data-gall="portfolioGallery" class="venobox" title="Card 2"><button>ZOOM</button></a>
                              <a data-toggle="modal" data-target="#addtocart" title="Add to Cart"><button id="<?php echo $index; ?>" onClick="copyMenu(this.id)">ADD CART</button></a>
                            </div>
                          </div>
                        </div>
