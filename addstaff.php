...
<head>
  ...
  <title>Burgerak - Add Staff</title>
            ...
            <form action="newstaff.php" method="post">
              ...
              <fieldset>
                ...
                <div  class="account-details">
                  ...
                  <div><label>Email Address</label><input type="text" name="email" required></div>
                  <div><label>Phone Number</label><input type="text" pattern="[0-9.]*"  name="phoneno" required></div>
              ...
              <fieldset>
                ...
                <div  class="terms-mailing">
                  <div class="checkbox">
                    <input type="checkbox" name="checkbox" required><span>I'm sure that this details is real and meet the criteria and requirements from Burgerak.</a></span>
                  </div>
              </fieldset>
