...
{
  $sqlCust = "SELECT * from admin  where admin_username = '".$_SESSION['username']."' ";
          ...
          <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <form action="updateprofile.php" method="post" >
              ...
              <div class="container">
                ...
                <input type="text" placeholder="Enter Full Name" name="fullname" value="<?php echo $dataC['admin_fullname']?>" required><br>

                <label for="uname">Username : </label><br>
                <input type="text" placeholder="Enter Username" name="uname" value="<?php echo $dataC['admin_username']?>" required><br>

                <label for="psw">Password : </label><br>
                <input type="password" placeholder="Enter Password" name="psw" value="<?php echo $dataC['admin_password']?>" readonly required><br>

                <label for="email">E-mail address : </label><br>
                <input type="text" placeholder="Enter e-mail" name="email" value="<?php echo $dataC['admin_email']?>" required><br>

                <label for="phoneno">Phone Number : </label><br>
                <input type="text" placeholder="Enter Phone Number" name="phoneno" value="<?php echo $dataC['admin_phoneno']?>" pattern="[0-9]*"required><br>
                    
                <input id="update" class="btn btn-primary" name="submit" type="button" value="Update">
