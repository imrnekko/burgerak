...
?>
      ...
      <head>
        ...
        <title>Burgerak - Order Details</title>
      ...
      <body>
        ...
        <section id="hero" class="d-flex align-items-center">
          <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
            ...
            <p>Please confirm your order details and enter your contact details below.</p>
            ...
            <div class="table-responsive">
              ...
              <table id="table">
                          ...
                          <?php $counter++; }
                            ...
                            $rounding = round($subtotal*$sstrate,1) - ($subtotal*$sstrate);
                        ...
                        <tr>
                          <td colspan = "4"><b>TOTAL PRICE (NOT INCLUDE DELIVERY PRICE): </b></td>
                          <td><b>RM <?php echo number_format((float)$total+$rounding, 2, '.', '');?></b></td>
                        </tr>
             ...
             <section id="preview" class="d-flex align-items-center">
              <div class="container text-center position-relative" data-aos="fade-in" data-aos-delay="200">
                ...
                <h1><i class="fas fa-phone"></i> Contact Details</h1>
                <p>Please confirm your order details and enter your contact details below.</p>
                        
                <hr>
                <form action="afterpreview.php?orderid=<?php echo $_GET['orderid'];?>" method="post" >
                          
                  <?php 

                    $sqlCust = "SELECT * from customer where cust_username = '".$_SESSION['username']."' ";
                    $qryCust = mysqli_query($con, $sqlCust);

           

                      $dataCust = mysqli_fetch_assoc($qryCust);
                  ...
                  <div class="container">
                    ...
                    <input type="text" placeholder="Full name" name="fullname" value="<?php echo $dataCust['cust_fullname'];?>" required><br>

                    <label for="email">E-mail address : </label><br>
                    <input type="text" placeholder="E-mail" name="email" value="<?php echo $dataCust['cust_email'];?>" required><br>
                
                    <label for="phoneno">Phone Number : </label><br>
                    <input type="text" placeholder="Phone Number" name="phoneno" value="<?php echo $dataCust['cust_phoneno'];?>" pattern="[0-9]*"required><br>

                        
                    <button type="submit" class="btn btn-success">SUBMIT</button>
                    <a href="cancelorder.php?orderid=<?php echo $_GET['orderid']; ?>" class="btn btn-danger">CANCEL</a>
                          
                    <input type="hidden" name="subtotalprice" value="<?php echo $subtotal;?>" required><br>
                    <input type="hidden" name="totalprice" value="<?php echo $total+$rounding;?>" required><br>
                  </div>
