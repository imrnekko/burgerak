...
?>
  ...
  <form method= "post" action="updateToDeliver.php" >
  <div class="row">
    <div class="col-25">
    ...
    <div class="col-75">
       ...
       <p style="font-size:12pt;font-family:Poppins;"><?php echo $dataF['state']?></p>
            ...
            <div class="table-responsive">
              ...
              <hr>
              <a href="toDeliverTable.php"><button  type="button" style="width:120px;height:60px;font-size:14pt;font-weight:bold;">BACK</button></a>
